...
const NewReviewForm: React.FC<NewReviewProps> = ({ movieId, movieTitle }) => {movieId, movieTitle,}) => {
  ...
  const onSubmit = async ({ description, score, reviewPicture }: FormData) => {const imgUrl = await uploadPhoto(reviewPicture[0]
